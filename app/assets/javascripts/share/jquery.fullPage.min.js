    ...
    b.fn.fullpage = function (c) {
        function m(a) {
            if (c.autoScrolling) {
                ...
                var e;
                e = b(".page.active");
                if (!k)if (e = e.find(".slides").length ? e.find(".slide.active").find(".scrollable") : e.find(".scrollable"), 0 > a)if (0 < e.length)if (v("bottom", e))b.fn.fullpage.moveSectionDown(); else return !0; else b.fn.fullpage.moveSectionDown(); else if (0 < e.length)if (v("top", e))b.fn.fullpage.moveSectionUp(); else return !0; else b.fn.fullpage.moveSectionUp();
                return !1
            }
        }
        ...
        function n(a, e) {
            var d = {}, f, h = a.position(), h = null !== h ? h.top : null, H = G(a), l = a.data("anchor"), g = a.index(".page"), p = a.find(".slide.active");
            if (p.length) {
                f = p.data("anchor");
                var q = p.index()
            }
            p = b(".page.active").index(".page") + 1;
        ...
        function u(a, e) {
            var d = e.position(), f = a.find(".slidesContainer").parent(), h = e.index(), g = a.closest(".page"), l = g.index(".page"), k = g.data("anchor"), p = g.find(".fullPage-slidesNav"), q = e.data("anchor");
            if (c.onSlideLeave) {
        ...
        function G(a) {
            var c = b(".page.active").index(".page");
            a = a.index(".page");
            return c > a ? "up" : "down"
        }
        ...
        function w(a) {
            ...
            var b = a.closest(".page"), d = a.find(".scrollable");
        ...
        function A(a, c) {
            var d = isNaN(a) ? b('[data-anchor="' + a + '"]') : b(".page").eq(a - 1);
        ...
        b(window).scroll(function (a) {
            if (!c.autoScrolling) {
                ...
                if (!a.hasClass("active")) {
                    C = !0;
                    var d = G(a);
                    b(".page.active").removeClass("active");
                    a.addClass("active");
                    var f = a.data("anchor");
                    b.isFunction(c.onLeave) && c.onLeave.call(this, a.index(".page"), d);
                    b.isFunction(c.afterLoad) && c.afterLoad.call(this, f, a.index(".page") + 1);
                    K(f);
                    L(f, 0);
        ...
        b(document).on("touchmove", function (a) {
            if (c.autoScrolling && B) {
                ...
                a = a.originalEvent;
                var e = b(".page.active");
                if (!k && !s)if (E = a.touches[0].pageY, y = a.touches[0].pageX, e.find(".slides").length && Math.abs(x - y) > Math.abs(D - E))x > y ? e.find(".controlArrow.next").trigger("click") : x < y && e.find(".controlArrow.prev").trigger("click"); else if (a = e.find(".slides").length ? e.find(".slide.active").find(".scrollable") : e.find(".scrollable"), D > E)if (0 < a.length)if (v("bottom", a))b.fn.fullpage.moveSectionDown(); else return !0; else b.fn.fullpage.moveSectionDown(); else if (0 < a.length)if (v("top", a))b.fn.fullpage.moveSectionUp(); else return !0; else b.fn.fullpage.moveSectionUp()
            }
        });
        ...
        b.fn.fullpage.moveSectionUp = function () {
            var a = b(".page.active").prev(".page");
            c.loopTop && !a.length && (a = b(".page").last());
            (0 < a.length || !a.length && c.loopTop) && n(a)
        };
        b.fn.fullpage.moveSectionDown = function () {
            var a = b(".page.active").next(".page");
            c.loopBottom && !a.length && (a = b(".page").first());
            (0 < a.length || !a.length && c.loopBottom) && n(a)
        };
        b.fn.fullpage.moveTo = function (a, c) {
            var d = "", d = isNaN(a) ? b('[data-anchor="' + a + '"]') : b(".page").eq(a - 1);
        ...
        b(document).keydown(function (a) {
            if (!k)switch (a.which) {
                ...
                case 34:
                    ...
                    break;
                case 37:
                    b(".page.active").find(".controlArrow.prev").trigger("click");
                    break;
                case 39:
                    b(".page.active").find(".controlArrow.next").trigger("click")
            }
        });
        ...
        b(".page").on("click", ".controlArrow", function () {
            if (!s) {
                s = !0;
                var a = b(this).closest(".page").find(".slides"), c = a.find(".slide.active"), d = null, d = b(this).hasClass("prev") ? c.prev(".slide") : c.next(".slide");
                d.length || (d = b(this).hasClass("prev") ? c.siblings(":last") : c.siblings(":first"));
                u(a, d)
            }
        });
        b(".page").on("click", ".toSlide", function (a) {
            a.preventDefault();
            a = b(this).closest(".page").find(".slides");
            a.find(".slide.active");
